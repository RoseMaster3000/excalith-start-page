...
This is a fork of [Excalith Start Page](https://github.com/excalith/excalith-start-page). I use it as my new tab page with [this extension](https://addons.mozilla.org/en-US/firefox/addon/new-tab-override/). The following changes have been made:
...
* Link icons take on color of its parent list, with slight de-saturation
* Added login page with hardcoded hashed in `src/pages/login.jsx`
